...
package Vst3.Factory is 
   ...
   -- NOTE(edg): These are useful for defining fixed C string types in the info structs, maybe we'll need to use them
   -- another time?
   ...
   function Add_Ref (this : access Plugin_Factory)
      return Unsigned
      with Convention => C;

   function Release (this : access Plugin_Factory) 
      return Unsigned
      with Convention => C;

   function Query_Interface (This : access Plugin_Factory; Iid : TUID; Obj : access Address) 
      return Result
      with Convention => C;

   function Get_Factory_Info (This : access Plugin_Factory; Info : access Factory_Info)
      return Result
      with Convention => C;

   function Count_Classes (This : access Plugin_Factory)
      return Int
      with Convention => C;

   function Get_Class_Info (This : access Plugin_Factory; Index : Int; Info: access Class_Info)
      return Result
      with Convention => C;

   function Create_Instance (This : access Plugin_Factory; Class_Id : TUID; Interface_Id : TUID; Obj : access Address)
      return Result
      with Convention => C;

   function Get_Class_Info_2 (This : access Plugin_Factory; Index : Int; Info : access Class_Info_2) 
      return Result 
      with Convention => C;

   function Get_Class_Info_W (This : access Plugin_Factory; Index : Int; Info : access Class_Info_W) 
      return Result 
      with Convention => C;

   function Set_Host_Context (This : access Plugin_Factory; Context : access Unknown) 
      return Result 
      with Convention => C;

   type I_Plugin_Factory_3_V_Table is record
      Query_Interface   : access function (This : access Plugin_Factory; Interface_Id : TUID; Obj : access Address) return Result with Convention => C;
      Add_Ref           : access function (This : access Plugin_Factory) return Unsigned with Convention => C;
      Release           : access function (This : access Plugin_Factory) return Unsigned with Convention => C;
      Get_Factory_Info  : access function (This : access Plugin_Factory; Info : access Factory_Info) return Result with Convention => C;
      Count_Classes     : access function (This : access Plugin_Factory) return Int with Convention => C;
      Get_Class_Info    : access function (This : access Plugin_Factory; Index : Int; Info: access Class_Info) return Result with Convention => C;
      Create_Instance   : access function (This : access Plugin_Factory; Class_Id : TUID; Interface_Id : TUID; Obj : access Address) return Result with Convention => C;
      Get_Class_Info_2  : access function (This : access Plugin_Factory; Index : Int; Info : access Class_Info_2) return Result with Convention => C;
      Get_Class_Info_W  : access function (This : access Plugin_Factory; Index : Int; Info : access Class_Info_W) return Result with Convention => C;
      Set_Host_Context  : access function (This : access Plugin_Factory; Context : access Unknown) return Result with Convention => C;
   end record
   with Convention => C_Pass_By_Copy;
